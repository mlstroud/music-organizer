...
```
git clone https://github.com/mlstroud/music-organizer.git
```
...
_Have a bug or an issue with this application? [Open a new issue](https://github.com/mlstroud/music-organizer/issues) here on GitHub._
